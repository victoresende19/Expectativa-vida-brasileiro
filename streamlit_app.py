...
if paginaSelecionada == 'Projeto CRISP-DM':
    ...
    st.write("<p align='justify'> A fase de avaliação serve como avaliador do objetivo alcançado, avaliando se o modelo criado possui as características requisitadas na fase de entendimento do negócio. <p align='justify'>", unsafe_allow_html=True)    
